...
from jumpserver.models import Operator,IdcType,AssetInstallSatus,AssetSatus,AssetType,AssetUseSatus,SystemArchVersion,SystemArchType,SystemType,Env,Brand,IncidentStatus
...
class IDC(models.Model):
    ...
    type = models.ForeignKey(IdcType)
...
class Asset(models.Model):
    ...
    system_version = models.ForeignKey(SystemArchVersion)
    system_type = models.ForeignKey(SystemType)
    system_arch = models.ForeignKey(SystemArchType)
    ...
    status = models.ForeignKey(AssetSatus)
